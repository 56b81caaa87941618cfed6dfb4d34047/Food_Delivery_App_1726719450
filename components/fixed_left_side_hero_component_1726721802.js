                ...
                <div class="min-h-full w-full max-w-xl mx-auto flex flex-col justify-start px-4 sm:px-6 pt-36 pb-20 lg:py-20 flex-1" id="quote-header">
                    <div class="grow flex flex-col justify-center" id="quote-content">
                        <div class="space-y-3" id="quote-container">
                            <div id="quote-title" class="font-caveat text-3xl text-blue-500">Hungry? We've got you covered.</div>
                            <h1 id="company-name" class="h1 font-orbiter font-bold text-white">Delicious Meals, Delivered to Your Door</h1>
                            <time id="quote-date" class="block font-caveat text-xl text-slate-400">Fast, fresh, and convenient food delivery from your favorite local restaurants</time>
                        </div>
                    </div>
                </div>
            </div>
